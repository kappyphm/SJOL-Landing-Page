  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen md:max-h-screen flex flex-col justify-between items-center ">
      ...
      <section className="w-full max-w-4xl text-center bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <Link
          href="https://drive.google.com/file/d/1qy7lMIyux7Ehw2gHbkapQ0Ch8lrxG2HK/view?usp=sharing"
          className="bg-blue-600 px-6 py-3 rounded-lg text-lg font-semibold hover:bg-blue-700"
        >
          Download now
        </Link>
